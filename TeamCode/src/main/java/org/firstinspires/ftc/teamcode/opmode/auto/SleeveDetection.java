...
public class SleeveDetection extends OpenCvPipeline {
    ...
    public final Scalar MAGENTA = new Scalar(255, 0, 255);

    /*
     * The core values which define the location and size of the sample regions
     */
    static final Point REGION_TOPLEFT_ANCHOR_POINT = new Point(850,500);
    ...
    public Mat processFrame(Mat input)
    {
         ...
         * at index 2 here.
         */
        avgCb = (int) Core.mean(region_Cb).val[0];
        avgCr = (int) Core.mean(region_Cr).val[0];
        ...
        else if(avgCb > 160) // Did it only have blue hue?
        {
            color = Color.BLUE;
            /*
             * Draw a solid rectangle on top of the chosen region.
